...
Call this script as follows:
    python serial-data-collect-csv.py -p <serial-port> [-b <baud-rate>] [-d <output-directory>] [-l <label>]
Send a character to the serial port by typing it in the console and pressing Enter.
